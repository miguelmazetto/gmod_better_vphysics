...
#include "qhull_user.hxx"      /* user definable constants (e.g., realT). */

#include "qhull_mem.hxx"   /* Needed for qhT in libqhull_r.h.  Here for compatibility */
#include "qhull_qset.hxx"   /* Needed for QHULL_LIB_CHECK */
...
#include "qhull_stat.hxx"  /* needs boolT */
