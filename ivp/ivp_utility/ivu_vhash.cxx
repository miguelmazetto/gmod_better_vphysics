...
void IVP_VHash::print()const{
    ...
    printf("%i:",len());
    for (i = 0; i<= size_mm;i++){
	printf (" %i:%zX:%X  ", elems[i].hash_index & size_mm, (size_t)elems[i].elem, elems[i].hash_index);
    }
    printf("\n");
}
...
void IVP_VHash_Store::print(){
    ...
    printf("%i:",size);
    for (i = 0; i< size;i++){
	printf (" %i:%zX:%zX:%X  ", elems_store[i].hash_index & size_mm, (size_t)elems_store[i].key_elem, (size_t)elems_store[i].elem, elems_store[i].hash_index);
    }
    printf("\n");
}
