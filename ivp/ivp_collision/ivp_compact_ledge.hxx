...
public:
  ...
  inline int get_is_virtual() const { return is_virtual; }
    ...
    inline size_t get_edge_index() const;
...
{
    size_t idx = (size_t)(((size_t)this) & 0x0c);
    return (IVP_Compact_Edge *)(((char *)this) + ((int *)(((char *)this->next_table)+idx))[0]);
}

size_t IVP_Compact_Edge::get_edge_index()const{
  size_t idx = (size_t((((size_t)this) & 0x0c))>>2) - 1;
    return idx;
}
